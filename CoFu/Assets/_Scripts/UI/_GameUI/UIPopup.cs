...
namespace GameUI
{
    ...
    public abstract class UIPopup : MonoBehaviour
    {
        ...
        [SerializeField] protected AnimationType animationType = AnimationType.Scale;
        ...
        protected virtual void PlayHideAnimation(System.Action onComplete = null)
        {
            ...
            {
                case AnimationType.Fade:
                    sequence.Append(canvasGroup.DOFade(0f, animationDuration).SetEase(Ease.InQuad));
                    break;

                case AnimationType.Scale:
                    sequence.Append(rectTransform.DOScale(0f, animationDuration).SetEase(Ease.InBack));
                    break;

                case AnimationType.SlideFromBottom:
                    Vector2 targetPos = new Vector2(rectTransform.anchoredPosition.x, -Screen.height);
                    sequence.Append(rectTransform.DOAnchorPos(targetPos, animationDuration).SetEase(Ease.InQuad));
                    break;
